          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li><a href="<?= base_url(); ?>#about" class="smoothScroll">About</a></li>
                         <li><a href="<?= base_url(); ?>#blog" class="smoothScroll">Blog</a></li>
                         <li><a href="<?= base_url(); ?>#work" class="smoothScroll">Waifu</a></li>
                         <li><a href="<?= base_url(); ?>#contact" class="smoothScroll">Info</a></li>
                    </ul>
